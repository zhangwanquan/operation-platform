...
public class RedisUtil {
    ...
    public void setList(String key, List<?> list){
        ...
        redisTemplate.opsForValue().set(key, list, expirationMilliSeconds, TimeUnit.MILLISECONDS);
    }
     ...
     * 批量添加位置
     */
    public Long addLocations(String geoKey, List<RedisGeoCommands.GeoLocation<MallInfo>> locations) {
        return redisTemplate.opsForGeo().add(geoKey, locations);
    }
     ...
     * @return 附近地点列表
     */
    public List<GeoResult<RedisGeoCommands.GeoLocation<MallInfo>>> findNearby(String geoKey, double lng, double lat,
                                                                              double radius, Metric metric) {
        Circle within = new Circle(new Point(lng, lat), new Distance(radius, metric));
        ...
        return redisTemplate.opsForGeo().radius(geoKey, within, args).getContent();
    }
}
